...
const RescueRequests = () => {
  ...
  const loadRequests = async () => {
    ...
    try {
      ...
      const res = await fetch("https://maaastha-website-bb9c.onrender.com/api/rescue-requests/all", {
  ...
  const handleUpdateStatus = async (id, newStatus) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://maaastha-website-bb9c.onrender.com/api/rescue-requests/update/${id}`,
        {
          method: "PATCH",
          headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("adminToken");
      const res = await fetch(
        `https://maaastha-website-bb9c.onrender.com/api/rescue-requests/delete/${id}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        },
                      ...
                      <img
                        src={
                          selectedReq.photoUrl.startsWith("http")
                            ? selectedReq.photoUrl
                            : `https://maaastha-website-bb9c.onrender.com${selectedReq.photoUrl}`
                        }
                        alt="Rescue Subject"
